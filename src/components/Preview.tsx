...
const MarkdownComponents = {
  code: CodeBlock,
  ul: ({ children }: any) => <ul className="list-disc list-outside mb-4 ml-8 space-y-1">{children}</ul>,
  ol: ({ children }: any) => <ol className="list-decimal list-outside mb-4 ml-8 space-y-1">{children}</ol>,
  li: ({ children }: any) => <li className="mb-0.5 ps-1">{children}</li>,
